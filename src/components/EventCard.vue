    ...
    <div class="block bg-white rounded-lg p-3 w-full m-auto">
      <div class="">
        <img
          ...
          class="max-h-32 w-full object-cover rounded-lg"
        />
      </div>
      <div class="bg-white w-full mt-4">
        <p class="text-[#2F2F2F] text-xs font-bold">
          {{ event.venue.name }}
        </p>
        <div class="w-full mt-4">
          <div class="mb-4">
            <div class="flex flex-wrap">
              <div class="flex items-center mr-7 pb-3">
                ...
                <p class="ml-3 text-xs text-[#6C757D]">
                  {{ event.venue.city }}
                </p>
              </div>
            </div>
            <div class="flex pb-2">
              <div class="flex items-center mr-7">
                ...
                <p class="ml-3 text-xs text-[#6C757D]">
                  Starting from
                  <span class="text-[#372AA4] text-sm font-semibold">
                    15,000
                  </span>
                </p>
              </div>
          ...
          <a
            :href="event.url"
            target="_blank"
            class="cursor-pointer inline-block mb-2 text-xs mr-2 py-2 px-4 text-[#372AA4] font-semibold border border-[#372AA4] rounded-lg hover:text-white hover:bg-[#372AA4] transition-all duration-300 ease-in-out"
          >
            Buy Ticket
          </a>
        </div>
